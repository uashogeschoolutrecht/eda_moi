...
This is a busy graph and for this Gapminder dataset not so informative bu parts of it can be useful as a next step to zoom in at with additional graphs. In Chapter \@ref(eda) we will see further examples of automated EDA. 
...
Add model to plot
In chapter \@ref(assumptionsmodels) we will see how to handle multiple models. For instance: imagine you want to creat a mode for each country seperately over time. Can you think of an application for such models?
```{r}

...
And are stored in the Global Environment of your R-session as `shipman_murders`
...
If we review the list above we can already can check a number of items from the list that we have taken care off. Let's take a look at the data first

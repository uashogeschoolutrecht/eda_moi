...
### Checking the assumption that a distribution is not significantly different from normal in a formal way
...
Let's execute the Shapiro test on out 'students' dataset. Here I use a bit more sofiscation to test all variables in the students dataset for normality, when we split by gender. 

We use the 'split' -> 'nest' -> 'iterate'  

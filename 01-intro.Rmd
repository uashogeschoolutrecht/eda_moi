...
### **EXERCISE** {-}
Using the function `installed.package()` and running the code below. Try to figure out how many packages are installed on the RSudio server instance that you have logged into.

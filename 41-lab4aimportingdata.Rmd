...
### **EXERCISE 1 - Construct a path to a data file** {-}
...
### **EXERCISE 2 - parser message in `{readr}`** {-}

A) Read the file "heigts.csv" in the "/data" folder into R, unsing the `{readr}` package.
If all goes well you you will see the following message: 
...
### **EXERCISE 3 - comments and skipping lines** {-}
...
9B) Which functions in R (you are allowed to google) can you use to read `xls`  or `xlsx`  files?

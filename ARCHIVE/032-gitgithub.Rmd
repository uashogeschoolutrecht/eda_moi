...
**=> To allow to exchange files with a remote repository, we will first have to tell git where this remote repository is located on the Web**
...
Go to your GitHub account and create a new **bare** repository called `dessert`

Then, within your local repository on your computer, you will need to tell git where on the web the repo is located the bare repository ready to receive the entire content of your local repository:

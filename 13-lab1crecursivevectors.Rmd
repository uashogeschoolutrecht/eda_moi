 ...
 * List
 * Dataframe: a special kind of list
 * Tibble: a special kind of dataframe

Below I will explain the difference

## The Dataframe
The dataframe is the most widely used data structure. If you use R for analyzing of data, this is the datstructure that you will use the most by far!
...
A matrix is basically a vector, with attributes that contain its dimensions
```{r}
matrix_num[1:10]
...
## For more on learning R, start with:
...
and the rest of Mike Marin's lectures, those are also a really great way to start learning R.
Or try datacamp.com
